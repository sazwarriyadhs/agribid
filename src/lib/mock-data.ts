...
export const allActiveAuctions = [
    ...
    {
      id: '5',
      name: 'Free-range Chicken Egg Auction',
    ...
    {
      id: '11',
      name: 'Live Broiler Chicken Auction',
    ...
    {
      id: '14',
      name: 'Gayo Arabica Coffee Auction',
      name_id: 'Lelang Kopi Arabika Gayo',
      image: 'https://placehold.co/600x400.png',
      aiHint: 'arabica coffee beans',
      seller: 'Java Export Coffee',
      seller_id: 'Java Export Coffee',
      sellerRole: 'exporter',
      currentBid: 65000,
      bidders: [],
      category: 'Perkebunan',
    ...
    {
      id: '15',
      name: 'Fermented Dried Cocoa Auction',
      name_id: 'Lelang Kakao Kering Fermentasi',
      image: 'https://placehold.co/600x400.png',
      aiHint: 'fermented dried cocoa beans',
      seller: 'Sulawesi Cocoa Export',
      seller_id: 'Sulawesi Cocoa Export',
      sellerRole: 'exporter',
      currentBid: 72000,
      bidders: [],
      category: 'Perkebunan',
    ...
    {
      id: '16',
      name: 'Original Forest Honey Auction',
